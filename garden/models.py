...
class Category(enum.Enum):
    ...
    herb_perennial_ornamental = {'title': 'Травянистые многолетние декоративные', 'category_dir': '5/1'}
    herb_annual_ornamental = {'title': 'Травянистые однолетние декоративные', 'category_dir': '5/2'}
    herb_perennial_wild = {'title': 'Травянистые многолетние дикорастущие', 'category_dir': '5/3'} 
