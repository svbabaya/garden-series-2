...
class Category(enum.Enum):
    ...
    herb_perennial_ornamental = {'title': 'Многолетние декоративные', 'category_dir': '5/1'}
    herb_annual_ornamental = {'title': 'Однолетние декоративные', 'category_dir': '5/2'}
    herb_perennial_wild = {'title': 'Многолетние дикорастущие', 'category_dir': '5/3'} 
